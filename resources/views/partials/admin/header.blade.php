...
<header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
        @if (setting('general.admin_theme', 'skin-green-light') == 'skin-green-light')
            ...
            <span class="logo-mini"><img src="{{ asset('public/img/logo.png') }}" class="logo-image-mini" width="25" alt="Inventree Logo"></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><img src="{{ asset('public/img/logo.png') }}" class="logo-image-lg" width="25" alt="Inventree Logo"> <b>Inventree</b></span>
        @else
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini"><img src="{{ asset('public/img/logo-green.png') }}" class="logo-image-mini" width="25" alt="Inventree Logo"></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><img src="{{ asset('public/img/logo-green.png') }}" class="logo-image-lg" width="25" alt="Inventree Logo"> <b>Inventree</b></span>
        @endif
    </a>
