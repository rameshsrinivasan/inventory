...
class Invoices extends Controller
{
    ...
    public function create()
    {
        ...
        $items = Item::enabled()->orderBy('name')->get(['name', 'id', 'company_id', 'sale_price', 'quantity', 'tax_id']);
    ...
    public function addItem(ItemRequest $request)
    {
        ...
        $html = view('incomes.invoices.item-prefilled', compact('item_row', 'taxes', 'currency', 'items'))->render();
